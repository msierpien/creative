@php
     ...
     *
     * This template can be overridden by copying it to yourtheme/woocommerce/single-product/add-to-cart/variable.blade.php.
     *
...
<form class="variations_form cart" action="{!! esc_url(apply_filters('woocommerce_add_to_cart_form_action', $product->get_permalink())) !!}" method="post" enctype='multipart/form-data'
    ...
    @else
        ...
        <div class="single_variation_wrap">
            @php do_action('woocommerce_before_single_variation') @endphp
            @php do_action('woocommerce_single_variation') @endphp
            @php do_action('woocommerce_after_single_variation' )@endphp
        </div>
    @endif
